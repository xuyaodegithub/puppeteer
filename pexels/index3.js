let puppeteer = require( 'puppeteer' ), fs = require( 'fs' ), https = require( 'https' ), allkeywords, dataIdx = 3, page,
    browser, navigationPromise, exists, idx = 400;

function readFile() {
    fs.readFile( './index.json', 'utf8', (err, res) => {
